...
def _validate_image(image_path: str, titulo: str) -> bool:
    ...
    try:
        ...
        prompt = (
            ...
            f"Is this image PURELY a logo, wordmark, flyer, poster, infographic, or graphic design — "
            f"meaning: NO real people or real physical scenes are present, and the entire image is made of "
            f"designed/illustrated elements, text, or brand graphics?\n"
            f"IMPORTANT: A real photograph of PEOPLE standing in front of an event backdrop, branded stage, "
